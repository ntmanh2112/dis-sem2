...
public class AchivementView extends javax.swing.JFrame {
    ...
    public AchivementView() {
        ...
        initComponents();
        try {
                vLoad = AchievementModel.getAllAchievement();
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jComboBoxDoctorID, javax.swing.GroupLayout.Alignment.LEADING, 0, 355, Short.MAX_VALUE)
                    .addComponent(jTextFieldAchievementID, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 355, Short.MAX_VALUE))
                .addGap(63, 63, 63))
        );
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        try {
            test = AchievementModel.insertAchievement(objAchivement);
            if(test==1) {
        ...
        if (show == JOptionPane.YES_OPTION) {
            ...
            try {
                for (int i = 0; i < rArr.length; i++) {
                    test = AchievementModel.deleteAchievement(jTableAchivement.getValueAt(rArr[i], 0).toString());
                    if (test == 1) {
                        count++;
                    }
                }
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        objAchivement.setDoctor_id(jComboBoxDoctorID.getSelectedItem().toString());
        try {
            test = AchievementModel.updateAchievement(objAchivement);
            if(test==1) {
